...
def plot_losses(f_path, pp):
	...
	with open(f_path, 'r') as json_log:
		...
		print(dic)
		fig = plt.figure()
		plt.plot([0],[dic["train"]["loss"]], 'o',color="red", label="Train Accuracy")
		plt.plot([0],[dic["train"]["accuracy"]], 'o', color="black", label="Train Loss")
		plt.plot([0],[dic["eval"]["loss"]], 'o', color="blue", label="Eval Accuracy")
		plt.plot([0],[dic["eval"]["accuracy"]], 'o', color="pink", label="Eval Loss")
		plt.plot([0],[dic["test"]["loss"]], 'o', color="cyan", label="Test Accuracy")
